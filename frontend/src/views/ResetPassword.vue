  ...
  <div class="flex flex-col items-center justify-center min-h-[calc(100vh-96px)] bg-[#242424] text-gray-50">
    <div class="w-full max-w-md">
      ...
      <form @submit.prevent="resetPassword" class="space-y-4">
        <div>
          <label for="password" class="block text-lg font-semibold text-gray-300 mb-2">New Password</label>
        ...
        <div>
          <label for="confirmPassword" class="block text-lg font-semibold text-gray-300 mb-2">Confirm New
            Password</label>
